...
namespace Drupal\select_a11y\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'select_a11y' widget.
 *
 * @FieldWidget(
 *   id = "select_a11y",
 *   label = @Translation("Select a11y"),
 *   field_types = {
 *     "list_integer",
 *     "list_float",
 *     "list_string",
 ...
 * )
 */
class SelectA11yWidget extends OptionsSelectWidget {
